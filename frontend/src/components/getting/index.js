                        ...
                        <div className="row">
                            ...
                            <div className="heading col-md-12 col-sm-6">
                                ...
                                <div className="gta-content02">
                                    <p>thiagofonsecapix@gmail.com <Button className="btn" onClick={() => {navigator.clipboard.writeText('thiagofonsecapix@gmail.com')}}>Copiar</Button></p>
                            ...
                            <div className="heading col-md-12 col-sm-6">
                                <h1>Lista Online</h1>
                                <div className="gta-content02">
                                    <p><a href="https://listas.extra.com.br/simoneethiago2021" target="_blank">https://listas.extra.com.br/simoneethiago2021</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
